...
export declare class NamedTransformations extends APIResource {
    /**
     ...
     * ```
     */
    create(body: NamedTransformationCreateParams, options?: RequestOptions): APIPromise<Shared.NamedTransformation>;
    /**
     ...
     * ```
     */
    update(id: string, body: NamedTransformationUpdateParams, options?: RequestOptions): APIPromise<Shared.NamedTransformation>;
    /**
...
export declare namespace NamedTransformations {
    export { type NamedTransformationListResponse as NamedTransformationListResponse, type NamedTransformationCreateParams as NamedTransformationCreateParams, type NamedTransformationUpdateParams as NamedTransformationUpdateParams, };
}
//# sourceMappingURL=named-transformations.d.mts.map